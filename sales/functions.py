...
def cal_emp_incentive(empId, table2, quarter, salary, achieve, acc):
    ...
    if int(incentive.get(quarter=quarter).bettingSalary) == 0:
        if quarter == 1:
            ...
            return cal_emp_incentive(
                ...
                tempSalary,
                cal_acc(table2['achieve']['cumulation']['total']['q' + str(quarter - 1)])[0],
                cal_acc(table2['achieve']['cumulation']['total']['q' + str(quarter - 1)])[1]
            )
