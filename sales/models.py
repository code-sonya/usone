...
class Contract(models.Model):
    ...
    saleCompanyName = models.ForeignKey(Company, on_delete=models.SET_NULL, null=True, blank=True, related_name='saleCompanyName')
    ...
    endCompanyName = models.ForeignKey(Company, on_delete=models.SET_NULL, related_name='endCompanyName', null=True, blank=True)
...
class Revenue(models.Model):
    ...
    revenueCompany = models.ForeignKey(Company, on_delete=models.SET_NULL, null=True, blank=True)
