# Generated by Django 2.1.7 on 2019-06-14 16:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depositCondition', models.CharField(blank=True, choices=[('계산서 발행 후', '계산서 발행 후'), ('당월 말', '당월 말'), ('익월 초', '익월 초'), ('익월 말', '익월 말')], default='계산서 발행 후', max_length=20, null=True)),
