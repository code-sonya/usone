# Generated by Django 2.1.7 on 2019-06-04 14:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Cashflow',
            fields=[
                ('cashflowId', models.AutoField(primary_key=True, serialize=False)),
                ('price', models.BigIntegerField()),
                ('executionPrice', models.BigIntegerField()),
                ('executionRatio', models.FloatField()),
                ('flag', models.CharField(choices=[('매입', '매입'), ('매출', '매출')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, max_length=200, null=True)),
                ('cashflowId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.Cashflow')),
            ],
        ),
        migrations.CreateModel(
            name='Goal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchasePrice', models.BigIntegerField(blank=True, null=True)),
                ('accountingPurchasePrice', models.BigIntegerField(blank=True, null=True)),
                ('accountingProfitPrice', models.BigIntegerField(blank=True, null=True)),
                ('accountingProfitRatio', models.FloatField(blank=True, null=True)),
                ('comment', models.CharField(blank=True, max_length=200, null=True)),
                ('contractId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.Contract')),
