...
class DepartmentForm(forms.ModelForm):
    ...
    class Meta:
        model = Department
        fields = ('deptName', 'deptManager', 'deptLevel', 'parentDept', 'startDate', 'endDate', 'departmentStatus')
        ...
        widgets = {
            ...
            'departmentStatus': forms.Select(attrs={'class': 'form-control', 'id': 'departmentStatus'}),
        }
