...
class Employee(models.Model):
    ...
    empPhone = models.CharField(max_length=20, null=True, blank=True)
    empEmail = models.EmailField(max_length=254, null=True, blank=True)
    ...
    dispatchCompany = models.CharField(max_length=100, default='내근', null=True, blank=True)
    message = models.CharField(max_length=200, default='내근 업무 내용을 작성해 주세요.', help_text='내근 업무 내용을 작성해 주세요.', null=True, blank=True)
    carId = models.ForeignKey("extrapay.Car", on_delete=models.SET_NULL, null=True, blank=True)
    empAuth = models.CharField(max_length=10, default='일반', null=True, blank=True)
    empRank = models.IntegerField(default=10, null=True, blank=True)
    empSalary = models.IntegerField(default=0, null=True, blank=True)
    empAnnualLeave = models.FloatField(default=0, null=True, blank=True)
    empSpecialLeave = models.FloatField(default=0, null=True, blank=True)
    empRewardAvailable = models.CharField(max_length=10, choices=RewardAvailableChoices, default='가능', null=True, blank=True)
    empStartDate = models.DateField(null=True, blank=True)
    empEndDate = models.DateField(null=True, blank=True)
    empStamp = models.FileField(upload_to="stamp/", default='stamp/accepted.png', null=True, blank=True)
    profilePhoto = models.FileField(upload_to="profile/", default='profile/default.png', null=True, blank=True)
    empStatus = models.CharField(max_length=1, choices=statusChoices, default='Y', null=True, blank=True)
