    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dbMainEmpId', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dbMainEmpId', to='hr.Employee')),
                ('dbSubEmpId', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dbSubEmpId', to='hr.Employee')),
                ('saleEmpId', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='saleEmpID', to='hr.Employee')),
                ('solutionMainEmpId', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='solutionMainEmpID', to='hr.Employee')),
                ('solutionSubEmpId', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='solutionSubEmpId', to='hr.Employee')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
